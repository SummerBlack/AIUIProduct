...
public class ETDB {
	...
	public class DBHelper extends SQLiteOpenHelper {
		...
		private final static String TABLE_KEY_CREATE = "CREATE TABLE IF NOT EXISTS "
				...
				+ " INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ DBProfile.TABLE_KEY_FIELD_MASTER_CODE
				+ " VARCHAR(20),"
				+ DBProfile.TABLE_KEY_FIELD_ELECTRIC_INDEX
				+ " INTEGER,"
		...
		private final static String TABLE_KEYEX_CREATE = "CREATE TABLE IF NOT EXISTS "
				...
				+ " INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ DBProfile.TABLE_KEYEX_FIELD_MASTER_CODE
				+ " VARCHAR(20),"
				+ DBProfile.TABLE_KEYEX_FIELD_ELECTRIC_INDEX
				+ " INTEGER,"
		...
		private final static String TABLE_AIRDEVICE_CREATE = "CREATE TABLE IF NOT EXISTS "
				...
				+ " INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ DBProfile.TABLE_AIRDEVICE_FIELD_MASTERCODE
				+ " VARCHAR(20),"
				+ DBProfile.TABLE_AIRDEVICE_FIELD_ELECTRICINDEX
				+ " INTEGER,"
				+ DBProfile.TABLE_AIRDEVICE_FIELD_BRAND
				+ " INTEGER,"
				+ DBProfile.TABLE_AIRDEVICE_FIELD_INDEX
				+ " INTEGER,"
