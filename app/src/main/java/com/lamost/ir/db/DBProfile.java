...
public class DBProfile {
	...
	public static final String TABLE_DEVICE_FIELD_MASTER_CODE = "master_code";
	public static final String TABLE_DEVICE_FIELD_ELECTRIC_INDEX = "electric_index";
...
//	public static final String TABLE_DEVICE_FIELD_POS	= "device_pos";
	...
	public static final String TABLE_KEY_FIELD_MASTER_CODE = "master_code";
	public static final String TABLE_KEY_FIELD_ELECTRIC_INDEX = "electric_index";
	...
	public static final String TABLE_KEYEX_FIELD_MASTER_CODE = "master_cdoe";
	public static final String TABLE_KEYEX_FIELD_ELECTRIC_INDEX = "electric_index";
	...
	public static final String TABLE_AIRDEVICE_FIELD_MASTERCODE = "master_code";
	public static final String TABLE_AIRDEVICE_FIELD_ELECTRICINDEX = "electric_index";
	public static final String TABLE_AIRDEVICE_FIELD_BRAND = "air_brand";
	public static final String TABLE_AIRDEVICE_FIELD_INDEX = "air_index";
