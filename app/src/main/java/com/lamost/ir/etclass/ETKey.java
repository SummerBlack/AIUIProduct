...
public class ETKey implements IOp {
	...
	public void Inster(ETDB db) {
		...
		try {
			...
			keyValue.put(DBProfile.TABLE_KEY_FIELD_MASTER_CODE,getmMasterCode());
			keyValue.put(DBProfile.TABLE_KEY_FIELD_ELECTRIC_INDEX,getmElectricIndex());
